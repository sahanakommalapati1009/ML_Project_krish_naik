...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,train_array,test_array):
        try:
            ...
            # params that is used to store hyperparameter configurations for various machine learning models. 
            # This dictionary is typically used in conjunction with a hyperparameter tuning method (like GridSearchCV or RandomizedSearchCV) to evaluate different hyperparameter combinations for multiple models.
